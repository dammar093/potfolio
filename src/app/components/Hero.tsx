...
const Hero = () => {
  ...
  return (
    <div className="w-full mt-6">
      <div className="w-full h-full flex justify-between items-center flex-wrap-reverse">
        <div className="w-full md:w-[70%] mt-6 md:mt-0">
          <div className="text-2xl font-semibold">👋 Hello there</div>
          <div className="text-2xl font-semibold">Its me Dammar Singh Rana</div>
          <br />
          <div className="md:w-[90%] text-justify">
            <p>
              I am web developers to design & develop creative websites that
            ...
            <div className="flex gap-2 flex-wrap mt-6">
              {technologies.map((tech) => {
                return (
                  <div
                    key={tech}
                    className="border-gray-100 border rounded-2xl px-2 py-1"
                  >
                    {tech}
                  </div>
                );
      ...
      <div className="flex justify-center gap-6 mt-6 text-center">
        <div>
          ...
          <div className="text-3xl font-bold text-[#47A248]">M</div>
        </div>
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="text-3xl font-bold text-[#FFFFFF]">E</div>
        </div>
        <div>
          <svg
            width="50"
          ...
          <div className="text-3xl font-bold text-[#61DAFB]">R</div>
        </div>
        <div>
          <svg
            width="50"
          ...
          <div className="text-3xl font-bold text-[#8CC84B]">N</div>
        </div>
      </div>
    </div>
  );
